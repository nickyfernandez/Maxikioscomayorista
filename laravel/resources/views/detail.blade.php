    ...
    <section class="ftco-section">
    	<div class="container">
            ...
            @auth
               ...
               {{-- hacer que vaya a productos y que aprete el boton comprar del id? --}}
            @else
               <p><a href="/login" class="btn btn-black py-3 px-5">Registrate y compra!</a></p>  
            @endauth

            <p><a href="javascript:history.go(-1)" class="btn btn-black py-3 px-5">Atras</a></p>
            {{-- <p><a href="javascript:history.go(-1)">Atras</a></p> --}}
